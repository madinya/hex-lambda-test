...
class ContactPort(InMemoryPort):
    data_source = [
        Contact(id=1, client_id=1, name="Roberto", email="rm@mail.com",
                phone="123", status=1, created_date=datetime.now()),
        Contact(id=1, client_id=1, name="Sandra", email="sm@mail.com",
                phone="444", status=2, created_date=datetime.now()),
        Contact(id=1, client_id=2, name="Marcela", email="mm@mail.com",

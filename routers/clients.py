...
async def post(client: ClientSubmit) -> Client:
    return ClientInputPort.create(client)


@clients_router.put("/clients/{item_id}", response_model=Client)
async def put(item_id: int, client: ClientSubmit) -> Client:
